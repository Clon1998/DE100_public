...
CREATE TABLE `bans` (
  ...
  `playerid` varchar(255) CHARACTER SET latin1 NOT NULL,
  `von` varchar(255) CHARACTER SET latin1 NOT NULL,
  `datum` varchar(255) CHARACTER SET latin1 NOT NULL,
  `status` varchar(255) CHARACTER SET latin1 NOT NULL,
  `grund` varchar(255) CHARACTER SET latin1 NOT NULL,
  `insert_time` varchar(55) CHARACTER SET latin1 DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2018-09-06 18:15:15
