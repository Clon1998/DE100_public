...
--
-- Table structure for table `al_shopitems`
--

DROP TABLE IF EXISTS `al_shopitems`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `al_shopitems` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `shop_id` int(11) NOT NULL,
  `item_id` int(11) NOT NULL,
  `customName` varchar(45) DEFAULT NULL,
  `price` int(11) NOT NULL,
  `perm_var` varchar(45) DEFAULT NULL,
  `perm_val` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2018-09-06 18:15:10
