...
_picture = getText(configFile >> "CfgVehicles" >> _class >> "Icon");
if (_picture isEqualTo "iconObject_1x2") then {
	_picture = "\a3\ui_f\data\map\vehicleicons\iconobject_1x2_ca.paa";
};
