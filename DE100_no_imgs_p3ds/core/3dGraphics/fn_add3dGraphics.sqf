...

{
    ...
    call {
        if (_class isEqualTo "ICON") exitWith {
            _attributes params [
                ["_texture", ""],
                ["_color", [0, 0, 0, 1]],
            ...
            _cData pushBack [_class, _texture, _color, _position, _width, _height, _angle, _text, _shadow, _textSize, _font, _align, _drawSideArrows, _code];
        };
    
        if (_class isEqualTo "LINE") exitWith {
            _attributes params [
            ...
            _cData pushBack [_class, _start, _end, _lineColor, _code];
        };
    };
    nil
} count _gData;

de100_3dNamespace setVariable [_id,_cData];
de100_3dCache_f = de100_3dCache_f + 1;